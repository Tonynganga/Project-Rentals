...
urlpatterns = [
    ...
    path('rentals/get_appartment/<int:sub_loc>',AppartmentAPI.as_view({'get':'list_by_sub'}),name='get_appartment_per_sub'),
    path('rentals/get_appartment/',AppartmentAPI.as_view({'get':'list'}),name='get_appartment'),
